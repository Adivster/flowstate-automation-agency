    ...
    switch(option) {
      ...
      case 'lastRun':
        return [...workflowList].sort((a, b) => {
          // Handle "Never" as the lowest priority
          if (a.lastRun === 'Never') return 1;
          if (b.lastRun === 'Never') return -1;
          
          // Compare time-based strings (crude but effective for demo)
          // In a real app, parse these into actual Date objects
      ...
      <main className="flex-1 container mx-auto px-4 py-16 md:py-24">
        <TransitionWrapper>
          ...
          <div className="mb-12">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
              <div className="flex items-center">
                <div className="mr-5 bg-green-500/20 p-4 rounded-xl backdrop-blur-sm border border-green-500/30">
                  <GitBranch className="h-8 w-8 text-green-500 drop-shadow-[0_0_8px_rgba(34,197,94,0.8)]" />
                </div>
                <div>
                  <h1 className="text-3xl md:text-4xl font-bold text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.3)] mb-2">
                    {t('workflows')}
                  </h1>
              ...
              <Button 
                className="bg-flow-accent hover:bg-flow-accent/80 text-white shadow-lg hover:shadow-xl transition-all duration-300 px-5 py-6 h-auto self-start"
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <DialogContent className="max-w-4xl bg-flow-background/95 backdrop-blur-lg border-flow-border">
              {selectedWorkflow && (
                <>
                  <DialogHeader>
                    <div className="flex items-center">
                          ...
                          <div className="w-full mb-6 bg-flow-background/20 rounded-full h-3 overflow-hidden">
                            <div 
                              ...
                              style={{ 
                                ...
                                backgroundImage: `linear-gradient(to right, ${selectedWorkflow.color}90, ${selectedWorkflow.color})`,
