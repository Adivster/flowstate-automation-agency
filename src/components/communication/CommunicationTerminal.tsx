  ...
  return (
    <>
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-20 left-4 w-[50vw] max-w-[800px] min-w-[600px] z-40 rounded-xl overflow-hidden shadow-[0_0_30px_rgba(79,70,229,0.3)]"
          >
            <div className="flex w-full bg-gray-900/90 backdrop-blur-md border border-indigo-500/30 rounded-xl overflow-hidden">
              ...
              <div className="flex-1">
                ...
                >
                  ...
                  <div className="h-[500px]">
                    <TabsContent value="command" className="m-0 p-0 h-full">
      ...
      <Button
        ...
        className="fixed bottom-4 left-4 z-40 terminal-toggle-btn rounded-full h-12 w-12 shadow-lg bg-black/70 border border-indigo-500/50 hover:bg-indigo-900/30 hover:border-indigo-400/80 transition-all duration-300 flex items-center justify-center"
      >
        {activeTab === 'command' ? (
